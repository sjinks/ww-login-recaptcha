...
<div class="wrap">
	...
	<p><?=\__('All settings except "Active" can be overridden by other network sites.', 'wwlr-admin'); ?></p>

	<form action="<?=\esc_attr(\admin_url('admin-post.php'));?>" method="post">
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row"><label for="active">Active</label></th>
					<td><?php WildWolf\LoginRecaptcha\WPUtils::checkbox(['label_for' => 'active', 'sitewide' => true]); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="invisible">Invisible</label></th>
					<td><?php WildWolf\LoginRecaptcha\WPUtils::checkbox(['label_for' => 'invisible', 'sitewide' => true, 'help' => \__('Check this if you have signed up for "Invisible reCAPTCHA badge"', 'wwlr-admin')]); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="sitekey">Site Key</label></th>
					<td><?php WildWolf\LoginRecaptcha\WPUtils::input_field(['label_for' => 'sitekey', 'sitewide' => true]); ?></td>
				</tr>
				<tr>
					<th scope="row"><label for="secretkey">Secret Key</label></th>
					<td><?php WildWolf\LoginRecaptcha\WPUtils::input_field(['label_for' => 'secretkey', 'sitewide' => true]); ?></td>
				</tr>
			</tbody>
		</table>
		<input type="hidden" name="action" value="save_ms_ww_login_recaptcha_options"/>
		<?php wp_nonce_field('save_ms_ww_login_recaptcha_options'); ?>
